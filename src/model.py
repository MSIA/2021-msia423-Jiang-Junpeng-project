...
def get_subset(name, data):
    ...
    """
    # subset the data based on input name
...
def recommend_topn(data, n):
    ...
    """
    # extract feature columns and calculate correlation matrices
    ...
    if n > data.shape[0]:
        ...
        # extract usable columns to ingest into RDS
...
def get_namelist(data):
    ...
    """
    # get a subset of games that have pos ratings > 500
