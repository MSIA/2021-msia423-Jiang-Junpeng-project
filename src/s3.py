...
#                         help="default upload")
#     parser.add_argument('s3path', default="s3://2021-msia423-jiang-junpeng/raw", action="store",
#                         help="If used, will load data via pandas")
#     parser.add_argument('local_path', default="data/steamdata/steam.csv", action="store",
